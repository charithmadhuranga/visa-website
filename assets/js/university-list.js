        ...
        <div class="bg-white rounded-2xl shadow-md card-hover overflow-hidden flex flex-col" data-aos="fade-up">
            ...
            <div class="p-6 flex flex-col flex-1">
                ...
                <div class="flex flex-wrap gap-2 text-xs mb-3">
                    <span class="bg-blue-50 text-[#C9A45C] px-2.5 py-1 rounded-full"><i class="fas fa-location-dot mr-1"></i>${u.city}</span>
                ...
                <div class="text-xs text-gray-600 mt-auto">
                    <div class="bg-gray-50 rounded-lg p-2.5"><i class="fas fa-user-graduate text-[#C9A45C] mr-1"></i>${u.students}</div>
                </div>
