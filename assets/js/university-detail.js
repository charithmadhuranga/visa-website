        ...
        <section class="page-hero">
            <div class="container mx-auto px-6" data-aos="fade-up">
                <figure class="relative max-w-3xl mx-auto rounded-2xl overflow-hidden shadow-2xl mb-8 bg-gradient-to-br from-blue-900 to-blue-700">
                    <div role="img" aria-label="${uni.name} campus" style="background-image:url('../images/universities/${uni.id}.jpg?v=3');background-size:cover;background-position:center;background-repeat:no-repeat;height:clamp(256px,45vw,384px)"></div>
